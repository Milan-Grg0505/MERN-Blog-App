      ...
      <div className='px-4 md:px-2'>
        <div className='max-w-7xl mx-auto flex flex-col md:flex-row items-center h-[600px] my-10 md:my-0 '>
          ...
          <div className='max-w-2xl'>
            ...
            <p className='text-lg md:text-xl opacity-80 mb-6'>Stay ahead with in-depth articles, tutorials, and insights on web developkment,digital marketing and tech innovations.
            </p>
           ...
           */}
           ...
           <div className='flex items-center justify-center'>
            <img src={heroImg} alt="blog" className='md:h-[550px] md:w-[550px]' />
